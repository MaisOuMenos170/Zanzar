...
Run from `.agents/skills/create-feature/` or pass `--repo-root` pointing at the Zanzar repo root.
...
For the full layer contract, see [references/architecture.md](../create-feature/references/architecture.md).
